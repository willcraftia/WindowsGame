...
namespace Willcraftia.Xna.Foundation.Debugs
{
    ...
    public static class KeyboardUtils
    {
        ...
        /// キー情報から文字を取得する
        /// </summary>
        /// <param s="button">押下されたキー</param>
        /// <param s="shitKeyPressed">シフトキーが押されていたか?</param>
        /// <param s="character">キー入力から変換された文字</param>
        ...
        public static bool KeyToString(Keys key, bool shitKeyPressed, out char character)
        {
            ...
            {
                // CameraStrategy～Z、スペースキーはそのまま文字コードとして使用する
