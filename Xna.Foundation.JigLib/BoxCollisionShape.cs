...
{
    /// <summary>
    /// JigLibX 環境での IBoxCollisionShape 実装です。
    /// </summary>
    public sealed class BoxCollisionShape : Box, IBoxCollisionShape
    {
        /// <summary>
        /// インスタンスを生成します。
        /// </summary>
        public BoxCollisionShape()
            : base(Vector3.Zero, Matrix.Identity, Vector3.One)
        {
        }

        public override Primitive Clone()
        {
            var clone = new BoxCollisionShape();
            clone.Position = Transform.Position;
            clone.Orientation = Transform.Orientation;
            clone.SideLengths = SideLengths;
            return clone;
        }
