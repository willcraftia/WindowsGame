...
{
    public sealed class EditProjectPropertiesMessageAction : MessageActionBase<EditProjectPropertiesMessage>
    {
        protected override void InvokeAction(EditProjectPropertiesMessage message)
        {
            var d = new ProjectPropertiesDialog();
