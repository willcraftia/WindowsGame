...
namespace Willcraftia.Xna.Foundation.JigLib.Cube
{
    ...
    public sealed class CollDetectCapsuleCubicHeightmap : DetectFunctor
    {
        ...
        DetectFunctor capsuleBoxDetectFunctor;
        ...
        DetectFunctor capsulePlaneDetectFunctor;

        #endregion

        #region Constructors

        public CollDetectCapsuleCubicHeightmap()
            : base("BoxCubicHeightmap", (int) PrimitiveType.Capsule, PrimitiveTypeManager.GetPrimitiveType<CubeHeightmapCollisionShape>())
        {
